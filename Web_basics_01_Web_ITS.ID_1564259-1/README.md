...
- Реализуй интерактивное меню:

    - Подсветка активного пункта меню в зависимости от текущей страницы.

Здесь ты поработаешь над файлом `js/script.js`.

- Добавь динамическую подгрузку контента:

    - Пусть при клике на изображение врача на странице `doctors.html` будет всплывать дополнительная информация о нем.
